...
@Component({
  ...
  templateUrl: './testando-menu.component.html',
  styleUrl: './testando-menu.component.scss'
})
export class TestandoMenuComponent implements OnInit {
